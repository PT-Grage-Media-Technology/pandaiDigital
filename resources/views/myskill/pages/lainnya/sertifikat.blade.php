...
<html lang="en">
  <head>
    ...
    .cap {
        ...
        left: -10px; /* Adjust to move closer to the CEO signature */
        z-index: 1;
    }
    ...
    .ceo-signature {
      ...
      .signature-title {
        ...
        .grade {
            ...
            line-height: 1; /* Pastikan teks berada di tengah secara vertikal */
            margin-top: 20px;
        }
  ...
  <body>
     ...
     @php
        ...
        $faviconBase64 = file_exists($faviconPath) ? 'data:image/png;base64,' . base64_encode(file_get_contents($faviconPath)) : '';
        ...
        $ttdTrainerBase64 = file_exists($ttdTrainer) ? 'data:image/png;base64,' . base64_encode(file_get_contents($ttdTrainer)) : '';
     @endphp

     
    <div class="certificate" style="margin-left: 10px; margin-top: 3px">
      <!-- Inner Content -->
