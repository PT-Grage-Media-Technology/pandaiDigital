...
<div class="corporate w-screen">
    ...
    <section class="w-screen h-auto">
        ...
        <div class="flex flex-col-reverse md:flex-row md:mr-12 justify-center md:justify-end gap-12 px-4 md:px-0">
            ...
            <img src="./assets/corporate/WhatsApp Image 2024-10-29 at 14.23.06_c6021c8e.jpg" alt="Performance Management Software"
                class="h-64 w-3/6 object-cover shadow-lg rounded-lg md:w-96 lg:h-auto lg:w-3/6 max-w-xs md:max-w-none mx-4 md:mx-0">
        </div>
        ...
        <div class="min-h-screen flex items-center justify-center mt-9 px-4 sm:px-6 lg:px-8" id="call">
            <div class="w-full max-w-lg">
                <h2 class="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-center">Hubungi Pandai Digital trainer untuk Diskusi
                    Lebih Lanjut</h2>
                <form action="{{ route('administrator.pesanmasuk.store') }}" method="POST" class="bg-white space-y-4 sm:space-y-6 p-4 sm:p-6">
                    @csrf
