...
<div class="corporate">
    <section
        ...
        <div class="lg:ml-4 lg:mt-8 p-4 lg:p-0 w-screen">
            <button type="button"
                class="focus:outline-none text-white bg-gray-900 font-medium rounded-full text-sm px-5 py-2.5 me-2 dark:focus:ring-yellow-900 mb-4 lg:mb-0" onclick="location.href='#call'">Pandai Digital
                for Business</button>
            <p class="text-base lg:text-4xl font-bold text-black lg:text-white lg:ml-8">
                Tingkatkan Skill & Performa Karyawan
            </p>
            <p class="text-base lg:text-4xl font-bold text-black lg:text-white mb-0 lg:ml-8">
                dengan Corporate Training
            </p>
            <p class="mt-2 text-sm lg:text-lg text-black lg:text-white lg:ml-8">Pandai Digital membantu ratusan enterprise, startup,
                badan pemerintahan dan</p>
            <p class="text-sm lg:text-lg text-black lg:text-white lg:ml-8"> institusi lainnya untuk mengembangkan potensi
                karyawan melalui </p>
            <p class="text-sm lg:text-lg text-black lg:text-white lg:ml-8">customizable training.</p>
            <br>

            <button type="button"
                class="focus:outline-none lg:ml-8 text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900" onclick="location.href='#call'">Konsultasi
    ...
    <h3 class="text-center w-screen mt-4 mr-100 text-3xl font-bold mb-4 text-black">Pandai Digital Dipercaya Ratusan Institusi Sebagai
        Learning Partner Karena</h3>
    <div class="flex flex-wrap justify-center mb-4 space-x-4 w-screen">
...
<section class="w-screen h-auto">
    <div class="text-center mb-4">
        <button type="button"
            class="focus:outline-none text-base sm:text-xl text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg px-4 sm:px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900" onclick="location.href='#call'">
