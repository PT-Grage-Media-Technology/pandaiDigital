            ...
            <div class="w-full h full  bg-white  p-6">
                ...
                <div id="elearning-content" class="text-start">
                    ...
                    @if ($elearningPayments->isEmpty())
                        ...
                        <div class="mt-10">
                            ...
                            <p class="mt-2 text-gray-600">Hmm, sepertinya kamu belum pernah berlangganan e-learning. Yuk
                                segera
                    ...
                    @else
                        ...
                        @if ($activePayments->isNotEmpty())
                            ...
                            @foreach ($activePayments as $payment)
                                <div class="mt-4 p-4 border border-gray-300 rounded-lg bg-green-100">
                                    <h3 class="text-lg font-semibold text-gray-800">{{ $payment->program_name }}
                                        {{ $payment->nama_berlangganan }}</h3>
                                    <p class="my-2 text-gray-600">Tanggal Pembayaran:
                                        {{ $payment->payment_datetime }}</p>
                                    Status: <p class=" text-green-600"> {{ ucfirst($payment->status) }}</p>
                                </div>
                            @endforeach
                        @else
                            <h2 class="text-xl font-semibold text-gray-800">Langganan Aktif: </h2>
                ...
                <div id="bootcamp-content" class="text-start hidden">
                    ...
                    @if ($bootcampPayments->isEmpty())
                        <p class="mt-2 text-gray-600">Hmm, sepertinya kamu belum pernah bergabung bootcamp Pandai Digital.
                            Yuk
                            eksplor
                ...
                <!--        <div class="mt-10">-->
                <!--            <h3 class="text-lg font-semibold text-gray-800">Pembelian Sebelumnya</h3>-->
                <!--            <p class="mt-2 text-gray-600">Hmm, sepertinya kamu belum pernah berlangganan review CV. Yuk-->
                <!--                segera-->
                ...
                <div class="flex justify-end gap-4 mt-6 hidden">
