        ...
        <div class="review">
            ...
            <div class="flex flex-col lg:flex-row">
                            ...
                            <ul class="space-y-1 py-3">
                                <li class="p-1 px-5">
                                    <a href="{{ route('profile.my-profile') }}"
                                        class="flex items-center text-blue-600 hover:bg-blue-100 rounded-lg p-2">
                ...
                <div class="w-full h-full bg-white p-8">
                    ...
                    <p class="text-sm text-center mb-6">Informasi mengenai profil dan preferensi kamu di seluruh layanan
                        Pandai Digital.</p>
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-1 px-5">
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" class="mt-2 p-2 w-full border rounded"
                                    value="{{ old('email', $user->email) }}" required>
                            </div>
                            <div>
                                <label for="no_telp" class="block text-gray-700">No. Telp</label>
                                <input type="text" id="no_telp" name="no_telp" class="mt-2 p-2 w-full border rounded"
                            ...
                            <div class="mt-6 flex items-center ml-6">
                                ...
                                <label for="subscribe" class="ml-2 text-gray-700">Saya bersedia menerima update informasi
                                    dari
                                    Pandai Digital</label>
                            </div>
                            <div class="mt-8 text-right">
                                <button type="submit"
                                    class="bg-teal-500 text-white px-6 py-2 rounded hover:bg-teal-600">Simpan
                                    Perubahan</button>
                            </div>
                    </form>
                </div>
