...
<div class="w-screen h-auto  rounded-b-3xl bg-gradient-to-b from-orange-400 to-red-500">
    ...
    <div>
        <h2
            class="lg:text-4xl max-sm:text-lg md:text-3xl text-center lg:py-14 md:py-12 max-sm:py-6 font-bold text-white">
            Mari Merintis Karir Bersama {{ $identitas->nama_website }}</h2>
    </div>


    <div class="md:overflow-x-auto max-sm:overflow-x-auto flex md:ps-4 max-sm:ps-2 md:gap-x-2 lg:gap-5 max-sm:gap-2 no-scrollbar max-sm:flex-nowrap max-sm:mx-4">
        <div
            ...
            <div class="p-5 max-sm:p-3 max-md:p-4">
                <h2 class="text-sm max-sm:text-xs max-md:text-sm text-center font-bold text-gray-900">
                    Noteworthy Lebih dari 1.5 Juta+ Member Belajar Bersama
                </h2>
        ...
        <div
            ...
            <div class="p-5 max-sm:p-3 max-md:p-4">
                <h5 class="text-sm max-sm:text-xs max-md:text-sm text-center font-bold text-gray-900">Ribuan Alumni Bekerja di National &
                    Global Company</h5>
            </div>
        </div>
        <div
            ...
            <div class="p-5 max-sm:p-3 max-md:p-4">
                <h5 class="text-sm max-sm:text-xs max-md:text-sm text-center font-bold text-gray-900">Praktikal & Bersertifikat. Bangun Skill
                    dan Portfolio</h5>
            </div>
        </div>
        <div
            ...
            <div class="p-5 max-sm:p-3 max-md:p-4">
                <h5 class="text-sm max-sm:text-xs max-md:text-sm text-center font-bold text-gray-900">4.9 Rating di Course Report & Award
        ...
        <div
            ...
            <div class="p-5 max-sm:p-3 max-md:p-4">
                <h5 class="text-sm max-sm:text-xs max-md:text-sm text-center font-bold text-gray-900">50k++ New Member Ikut Belajar Bulan
                </h5>
            </div>
        </div>
    </div>
...
<div>
    <h3 class="py-12 text-center font-bold text-2xl text-black">Berbagai Macam Program di {{ $identitas->nama_website }}</h3>
</div>

<div class="grid md:grid-cols-2 lg:py-10 w-screen">
    <img class="lg:w-96 md:w-80 max-sm:w-64 ms-10 lg:ms-48 max-sm:ms-auto max-sm:mr-10"
        src="{{ asset('img/image1.svg') }}" alt="" />
...
<!--    <img class="ms-10 w-80 lg:w-96 h-80 max-sm:w-64 lg:ps-20 max-sm:ms-auto max-sm:mr-10"-->
<!--        src="{{ asset('img/image3.svg') }}" alt="" />-->
<!--    <div class="text-start px-10 lg:px-20  lg:py-4">-->
...
<!--        <h2 class="font-bold text-black text-2xl">Corporate Service</h2>-->
<!--        <h1 class="text-black text-lg pt-7 font-semibold">Intensive Live Class bersama Experts. Praktikal & Mendalam-->
<!--        </h1>-->
<!--        <div class="ms-3">-->
<!--            <ul>-->
...
<h2 class="text-center font-bold text-2xl mx-3 lg:px-80 py-24">Rasanya Gabung Dengan Komunitas {{ $identitas->nama_website }} #Sipaling
    Ngoding
</h2>

<div class="snap-x snap-mandatory flex overflow-x-auto no-scrollbar ps-6 gap-11 mx-4"
    style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')"
    ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')"
    onmouseup="this.classList.remove('touching')">
...
<div class="snap-x snap-mandatory flex overflow-x-auto no-scrollbar ps-6 gap-5 lg:gap-11"
    ...
    onmouseup="this.classList.remove('touching')">
    @foreach ($links as $l)
    <div class="snap-always snap-center object-cover p-2 flex-shrink-0 w-48 h-24 mx-4 border border-black rounded-xl flex items-center justify-center">
        <img class="w-full h-full object-contain" src="{{ asset('foto_bannerhome/' . $l->gambar) }}" alt="" />
    </div>
    @endforeach
</div>
...
<div class="snap-x snap-mandatory flex overflow-x-auto no-scrollbar ps-6 gap-5 lg:gap-11"
    ...
    <div
        class="snap-always snap-center object-cover p-2 mx-4 flex-shrink-0 w-48 h-24 border border-black rounded-xl flex items-center justify-center">
        <img class="w-full h-full object-contain" src="{{ asset('foto_metode/' . $lb->gambar) }}" alt="" />
    </div>
    @endforeach
</div>
...
<div class="sm:mx-0 lg:mx-8">
    <div class="mb-1 border border-gray-300 rounded lg:mt-2 max-sm:mt-2 md:m-4 max-sm:p-1 max-sm:mx-1">
        <button class="w-full text-left bg-white p-2 rounded flex justify-between items-center font-semibold"
            ...
            Apakah {{ $identitas->nama_website }} bagus ?
            <i id="icon2"
        ...
        <div id="dropdown1"
            ...
            <p class="text-gray-700 block text-sm" role="menuitem">{{ $identitas->nama_website }} memiliki tiga fitur utama
                e-learning untuk belajar Mandiri via video modul belajar dan webinar series bulanan bootcamp
                untuk belajar intensif fokus pada praktik via Zoom.</p>
        </div>
    </div>
    ...
    <div class="mb-1 border border-gray-300 rounded lg:mt-2 max-sm:mt-2 md:m-4 max-sm:p-1 max-sm:mx-1">
        <button class="w-full text-left bg-white p-2 rounded flex justify-between items-center font-semibold"
            ...
            Apakah {{ $identitas->nama_website }} Berbayar ?
            <i id="icon3"
                class="fa-solid fa-chevron-down ml-2 text-sm mt-1.5 transition-transform duration-300"></i>
        </button>
        <div id="dropdown2"
    ...
    <div class="mb-1 border border-gray-300 rounded lg:mt-2 max-sm:mt-2 md:m-4 max-sm:p-1 max-sm:mx-1">
        <button class="w-full text-left bg-white p-2 rounded flex justify-between items-center font-semibold"
            ...
            Platform Pembayaran apa saja yang digunakan pada {{ $identitas->nama_website }} ?
            <i id="icon4"
                class="fa-solid fa-chevron-down ml-2 text-sm mt-1.5 transition-transform duration-300"></i>
        </button>
        <div id="dropdown3"
