    ...
    <section class="e-learning w-screen">
        ...
        <section class="bg-white">
            <div class="container mx-auto">
                ...
                <div
                    class="flex flex-nowrap md:mx-24 justify-start md:justify-center overflow-x-auto pb-3 space-x-4 mx-4 snap-x no-scrollbar">
                        ...
                        <div class="snap-start flex-shrink-0 w-40 md:w-48 h-auto group">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    <a href="{{ $train->link }}">
                                        <button
                                            class="bg-white text-black py-2 px-4 rounded-full text-sm font-medium hover:bg-gray-200 transition mb-5">Lihat
                                            Materi</button>
                                    </a>
                                </div>
                            </div>
