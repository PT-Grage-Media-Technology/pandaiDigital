    ...
    <div class="col">
        <div class="card card-shadow">
            <div class="card-header">
                <h3 class="mb-0">Tambah Metode</h3>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="padding: 5px;">
                                        <input type="text" class="form-control" id="nama_pembayaran" name="nama_pembayaran" placeholder="Masukkan Nama Pembayaran" required>
                                    </td>
                                </tr>
                                <tr>
