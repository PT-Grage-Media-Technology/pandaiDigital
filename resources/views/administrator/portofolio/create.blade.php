...
<div class="row">
    <div class="col">
        ...
        <div class="card-body">
                <form action="{{ route('administrator.portofolio.store') }}" method="POST" enctype="multipart/form-data" class="form-ajax">
                    @csrf
                    <table class="table" id="datatable-buttons" style="border: none; border-collapse: collapse;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px;">
                                    <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Nama" required>
                                </td>
                            </tr>
                            <tr>
