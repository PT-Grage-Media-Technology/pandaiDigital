    ...
    <div class="row">
        <div class="col">
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('administrator.berlangganan.store') }}" method="POST" enctype="multipart/form-data"
                        class="form-ajax">
                        @csrf
                            ...
                            <table class="table" id="datatable-buttons" style="border: none; border-collapse: collapse;">
                                <tbody>
                                  ...
                                  <tr>
                                        ...
                                        <td style="padding: 5px;">
                                            <input type="text" class="form-control" name="harga_berlangganan" id="harga_berlangganan"
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px;">
                                            <input type="text" class="form-control" name="harga_diskon" id="harga_diskonberlangganan"
