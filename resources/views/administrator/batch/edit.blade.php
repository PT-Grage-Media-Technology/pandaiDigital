                ...
                <div class="card-body">
                    <form action="{{ route('administrator.batch.update', $batchs->id_batch) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px;">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="tanggal_mulai" name="tanggal_mulai" value="{{ $batchs->tanggal_mulai }}" style="background-color: white;">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="tanggal_selesai" name="tanggal_selesai" value="{{ $batchs->tanggal_selesai }}" style="background-color: white;">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 5px;">
                                        @foreach ($bootcamps as $bootcamp)
                                            @if($batchs->id_bootcamp == $bootcamp->id_bootcamp)
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('administrator.batch.index', ['id_bootcamp' => $batchs->id_bootcamp]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
