                    ...
                    <table class="table table-bordered" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('administrator.tugas.index', ['id_materi' => $materi->id_materi]) }}" class="btn btn-success btn-sm d-inline-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px;">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                    </div>
                                </td>
