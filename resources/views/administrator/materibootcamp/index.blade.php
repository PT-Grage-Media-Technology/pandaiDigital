                    ...
                    <table class="table table-bordered" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (strpos($materibootcamp->file, '.mp4') !== false || 
                                          strpos($materibootcamp->file, '.avi') !== false || 
                                          strpos($materibootcamp->file, '.mpeg') !== false)
                                        <video width="100" controls>
                                            <source src="{{ asset('files_materibootcamps/' . $materibootcamp->file) }}" type="video/mp4">
                                            Your browser does not support the video tag.
                                        </video>
                                    @elseif (strpos($materibootcamp->file, '.jpg') !== false || 
                                              strpos($materibootcamp->file, '.jpeg') !== false || 
                                              strpos($materibootcamp->file, '.png') !== false || 
                                              strpos($materibootcamp->file, '.gif') !== false || 
                                              strpos($materibootcamp->file, '.webp') !== false || 
                                              strpos($materibootcamp->file, '.svg') !== false)
