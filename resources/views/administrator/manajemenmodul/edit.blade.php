                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px;">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="status_pengajar" value="pengajar" required @checked($manajemenmodul->status == 'pengajar')>
                                        <label class="form-check-label" for="status_pengajar">Pengajar</label>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
