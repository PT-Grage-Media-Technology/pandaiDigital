                    ...
                    <table class="table" id="datatable-buttons" style="border: none; border-collapse: collapse;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px;">
                                    <textarea class="form-control" name="deskripsi" required>{{ str_replace(['<br>', '<br/>', '<br />'], '', htmlspecialchars($bootcamps->deskripsi)) }}</textarea>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <!--                    <input class="form-check-input" type="checkbox" name="id_trainer[]" value="{{ $trainer->id_trainer }}" id="trainer{{ $trainer->id_trainer }}"-->
                            <!--                           {{ (is_array($bootcamps->id_trainer) && in_array($trainer->id_trainer, $bootcamps->id_trainer)) ? 'checked' : '' }}>-->
                            <!--                    <label class="form-check-label" for="trainer{{ $trainer->id_trainer }}">-->
                                ...
                                <td style="padding: 5px;">
                                    <select class="form-control" name="id_trainer" required>
                                        <option value="">-- Pilih Trainer --</option>
                                            @foreach ($trainers as $trainer)
                                                <option value="{{ $trainer->id_trainer }}" {{ $trainer->id_trainer == $bootcamps->id_trainer ? 'selected' : '' }}>
                                                    {{ $trainer->nama_trainer }}
                                                </option>
                                            @endforeach
                                    </select>
...
<script>
    ...
    Autonumerik.set('#harga', 5000);
    Autonumerik.set('#harga_diskon', 5000);
</script>
@endsection
