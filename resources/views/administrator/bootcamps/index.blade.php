                ...
                <form action="{{ route('administrator.bootcamps.index') }}" method="GET" class="mb-1">
                    ...
                    @if (request('search') || request('judul_bootcamp'))
                        <div class="mt-2 d-flex justify-content-center">
                            <a href="{{ route('administrator.bootcamps.index') }}"
                        ...
                        <tbody>
                            @foreach ($bootcamps as $index => $bootcamp)
                                <tr>
                                    ...
                                    <td class="text-right">Rp. {{ number_format($bootcamp->harga, 0, ',', '.') }}</td>
                                    <td class="text-right">Rp. {{ number_format($bootcamp->harga_diskon, 0, ',', '.') }}</td>
                                    <td>{!! nl2br(e($bootcamp->deskripsi)) !!}</td>
                                    ...
                                    <td>
                                        @if($bootcamp->trainerAdmin)
                                            {{ $bootcamp->trainerAdmin->nama_trainer }} <!-- Akses nama_trainer dari hubungan trainerAdmin -->
                                        @else
                                            N/A
                                        @endif
                                    </td>
