...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('administrator.trainer.index') }}" method="GET" class="mb-1">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="input-group" style="max-width: 300px;">
                            <input type="text" class="form-control" placeholder="Cari Nama Trainer..." name="search" value="{{ request('trainer') }}">
                            <div class="input-group-append">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if ($trainer->ttd != NULL) {
                                            echo '<img style="width: 80px" src="' . url('ttd_trainer/' . $trainer->ttd) . '">';
                                        } else {
                                            echo 'Belum ada foto tanda tangan';
                                        }
                                    ?>
                                </td>
