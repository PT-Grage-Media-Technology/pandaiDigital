                ...
                <div class="card-body">
                    <form action="{{ route('administrator.programcv.index') }}" method="GET" class="mb-1">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="input-group" style="max-width: 300px;">
                                <input type="text" class="form-control" placeholder="Cari Nama Program CV..." name="search"
                            ...
                            <tbody>
                                @foreach ($programcvs as $index => $programcv)
                                    <tr>
                                        ...
                                        <td class="text-right">{{ number_format($programcv->harga_berlangganan, 0, ',', '.') }}</td>
                                        <td class="text-right">{{ number_format($programcv->harga_diskon, 0, ',', '.') }}</td>
