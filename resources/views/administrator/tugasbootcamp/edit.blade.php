    ...
    <div class="row">
        <div class="col">
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('administrator.tugasbootcamp.update', $tugasbootcamps->id_tugas_bootcamp) }}" method="POST" enctype="multipart/form-data"
                        class="form-ajax">
                        @csrf
                        @method('PUT')
                            ...
                            <table class="table" id="datatable-buttons" style="border: none; border-collapse: collapse;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px;">
                                            <input type="text" class="form-control" value="{{ $tugasbootcamps->bootcamp->judul_bootcamp }}" readonly>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('administrator.tugasbootcamp.index', ['id_bootcamp' => $tugasbootcamps->id_bootcamp]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
