            ...
            <div class="card-body">
                <form action="{{ route('administrator.kategoriprogram.update', $kategoriprograms->id_kategori_program) }}" method="POST" enctype="multipart/form-data" class="form-ajax">
                    ...
                    <table class="table" id="datatable-buttons" style="border: none; border-collapse: collapse;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px;">
                                    <input type="file" class="form-control" id="gambar" name="gambar" onchange="previewImage(event)" placeholder="Masukkan Gambar">
                                    <img id="preview" src="{{ asset('kategori_program/' . $kategoriprograms->gambar) }}"  alt="Gambar Sebelumnya" class="img-fluid">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="mt-4 d-flex justify-content-between">
                        ...
                        <a href="{{ route('administrator.kategoriprogram.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
