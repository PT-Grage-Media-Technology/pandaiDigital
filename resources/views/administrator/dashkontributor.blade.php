...
<div class="row">
    <div class="col">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="font-bold"><i class="fas fa-user"></i> Username: {{ $users['kontributor']->username }}</h5>
                <h5 class="font-bold"><i class="fas fa-envelope"></i> Email: {{ $users['kontributor']->email }}</h5>
                <h5 class="font-bold"><i class="fas fa-lock"></i> Password: <span class="text-muted">***</span></h5>
                <h5 class="font-bold"><i class="fas fa-phone"></i> No. Telepon: {{ $users['kontributor']->no_telp }}</h5>
