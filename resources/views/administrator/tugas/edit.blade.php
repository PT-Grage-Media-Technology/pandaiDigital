    ...
    <div class="row">
        <div class="col">
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('administrator.tugas.update', $tugass->id_tugas) }}" method="POST" enctype="multipart/form-data"
                        class="form-ajax">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('administrator.tugas.index', ['id_materi' => $tugass->id_materi]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
