    ...
    <div class="row">
        <div class="col">
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('administrator.tugas.store') }}" method="POST" enctype="multipart/form-data"
                        class="form-ajax">
                        @csrf
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('administrator.tugas.index', ['id_materi' => $materis->first()->id_materi ?? null]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
