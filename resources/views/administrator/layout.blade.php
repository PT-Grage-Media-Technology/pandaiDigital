                        ...
                        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                            ...
                            <ul class="navbar-nav">
                                            ...
                                            @if (
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/identitaswebsite') }}"><i
                                                            class='ni ni-diamond text-blue'></i> Identitas Website</a>
                                                </li>
                                            @endif
                                            @if ($cekMenuwebsite == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/menuwebsite') }}"><i
                                                            class='ni ni-bullet-list-67 text-orange'></i> Menu
                                                        Website</a>
                                                </li>
                                            @endif
                                        </ul>
                                ...
                                @php
                                    ...
                                    $cekKategoriBerita = $UserModul->umenu_akses(
                                        'kategoriberita',
                                        session('id_session'),
                                    );
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse" id="modul-berita">
                                            <ul class="nav nav-sm flex-column">
                                                @if ($cekBerita == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ url('administrator/berita') }}"><i
                                                                class='ni ni-paper-diploma text-blue'></i> Berita</a>
                                                    </li>
                                                @endif
                                                @if (
                                                    $cekKategoriBerita == 1 ||
                                                ...
                                                @endif
                                                @if ($cekTagBerita == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="{{ url('administrator/tagberita') }}"><i
                                                                class='ni ni-ruler-pencil text-purple'></i> Tag
                                                            Berita</a>
                                                    </li>
                                                @endif
                                            </ul>
                                    ...
                                    <div class="collapse" id="modul-video">
                                        <ul class="nav nav-sm flex-column">
                                            @php
                                                ...
                                                $cekTagvideo = $UserModul->umenu_akses(
                                                    'tagvideo',
                                                    session('id_session'),
                                                );
                                            @endphp
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse" id="modul-banner">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            @endif
                                            @if ($cekBannerhome == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse" id="modul-web">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            @if ($cekLogowebsite == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                    ...
                                    <div class="collapse" id="pandai-digital">
                                        <ul class="nav nav-sm flex-column">
                                            @php
                                                ...
                                                $cekBootcamps = $UserModul->umenu_akses(
                                                    'bootcamps',
                                                    session('id_session'),
                                                );
                                            ...
                                            @if ($cekBenefit == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/benefit') }}"><i
                                                            class='ni ni-diamond text-blue'></i> Benefit</a></li>
                                            @endif
                                            ...
                                            @if (
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/benefitbootcamp') }}"><i
                                                            class='ni ni-diamond text-blue'></i> Benefit Bootcamp</a>
                                                </li>
                                            @endif
                                            ...
                                            @if (
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/berlangganan') }}"><i
                                                            class='ni ni-credit-card text-blue'></i> Berlangganan</a>
                                                </li>
                                            @endif
                                            ...
                                            @if (
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/kategoriprogram') }}"><i
                                                            class='ni ni-collection text-orange'></i> Kategori
                                                        Program</a></li>
                                            @endif
                                            ...
                                            @if ($cekProgramcv == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/programcv') }}"><i
                                                            class='ni ni-single-copy-04 text-blue'></i> Program CV</a>
                                                </li>
                                            @endif
                                            ...
                                            @if ($cekTrainer == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/trainer') }}"><i
                                                            class='ni ni-single-02 text-orange'></i> Trainer</a></li>
                                            @endif

                                            @if ($cekSertifikat == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/sertifikat') }}"><i
                                                            class='ni ni-single-02 text-orange'></i> Sertifikat</a>
                                                </li>
                                            @endif
                                            @if ($cekPortofolio == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/portofolio') }}"><i
                                                            class='ni ni-single-02 text-orange'></i> Portofolio</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#modul-interaksi" data-toggle="collapse"
                                        role="button" aria-expanded="false" aria-controls="modul-interaksi">
                                    ...
                                    <div class="collapse" id="modul-interaksi">
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            @endif
                                            @if ($cekSekilasinfo == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/sekilasinfo') }}"><i
                                                            class='ni ni-single-copy-04 text-orange'></i> Sekilas
                                                        Info</a>
                                                </li>
                                            @endif
                                            @if (
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/jejakpendapat') }}"><i
                                                            class='ni ni-chart-bar-32 text-purple'></i> Jajak
                                                        Pendapat</a>
                                                </li>
                                            @endif
                                            @if ($cekPesanmasuk == 1 || session('level') == 'admin' || session('level') == 'user' || session('level') == 'pengajar')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/pesanmasuk') }}"><i
                                                            class='ni ni-chat-round text-orange'></i> Pesan Masuk</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                                            ...
                                            @if (
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/manajemenuser') }}"><i
                                                            class='ni ni-folder-17 text-blue'></i> Manajemen User</a>
                                                </li>
                                            @endif
                                            @if (
                                                $cekManajemenmodul == 1 ||
                                                ...
                                                <li class="nav-item"><a class="nav-link"
                                                        href="{{ url('administrator/manajemenmodul') }}"><i
                                                            class='ni ni-folder-17 text-orange'></i> Manajemen
                                                        Modul</a>
                                                </li>
                                            @endif
                                        </ul>
