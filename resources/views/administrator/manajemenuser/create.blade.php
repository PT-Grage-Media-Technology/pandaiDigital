...
@section('content')
<div class="row">
    <div class="col-12"> <!-- Full width on mobile, adjust as needed -->
        <div class="card card-shadow">
            ...
            <div class="card-body">
                <form action="{{ route('administrator.manajemenuser.store') }}" method="POST" enctype="multipart/form-data" class="form-ajax">
                    @csrf
                    <input type="hidden" name="is_subscribed" value="0"> <!-- Tambahkan input hidden ini -->
                        ...
                        <table class="table" id="datatable-buttons">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px; border: 1px solid #ddd;">
                                        <input type="tel" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan nomor telepon">
                                    </td>
                                </tr>
                                <tr>
