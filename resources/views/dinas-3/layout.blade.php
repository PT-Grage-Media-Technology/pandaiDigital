...
<head>
    ...
    <!-- Webpage Title -->
    <title>{{ $identitas->nama_website }} || Company Profile</title>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @foreach($menus as $menu)
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle nav-link" href="{{ url($menu->link) }}" id="navbarDropdown{{ $menu->id_menu }}" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: white;">
                                {{ $menu->nama_menu }}
                            </a>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown{{ $menu->id_menu }}">
                                ...
                                <li class="dropdown">
                                    <a href="{{ url($child->link) }}" class="dropdown-item page-scroll" id="navbarDropdownChild{{ $child->id_menu }}" role="button" aria-expanded="false">
                                        {{ $child->nama_menu }}
                                    </a>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownChild{{ $child->id_menu }}">
                                        ...
                                        <li class="dropdown">
                                            <a href="{{ url($subChild->link) }}" class="dropdown-item page-scroll" id="navbarDropdownSubChild{{ $subChild->id_menu }}" role="button" aria-expanded="false">
