                            ...
                            @if (Auth::user()->level === 'admin')
                                @if (request('search') || request('email') || request('email'))
                                    <div class="mt-2 d-flex justify-content-center">
                                        <a href="{{ route('pengajar.pengumpulantugas.index') }}"
                                            ...
                                            <td>
                                                @if (strpos($kumpultugas->file, '.mp4') !== false ||
                                                    ...
                                                    <video width="100" controls>
                                                        <source
                                                            src="{{ asset('files_pengumpulantugas/' . $kumpultugas->file) }}"
                                                            type="video/mp4">
                                                ...
                                                @elseif (strpos($kumpultugas->file, '.jpg') !== false ||
                                                    ...
                                                    <img src="{{ asset('files_pengumpulantugas/' . $kumpultugas->file) }}"
                                                        alt="Image" width="100">
                                                @elseif (strpos($kumpultugas->file, '.pdf') !== false)
                                                    <a href="{{ asset('files_pengumpulantugas/' . $kumpultugas->file) }}"
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <a class="btn btn-success btn-sm d-inline-flex align-items-center justify-content-center me-2"
                                                        ...
                                                        href="{{ route('pengajar.pengumpulantugas.edit', $kumpultugas->id_pengumpulan) }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <button
                                                        data-url="{{ route('pengajar.pengumpulantugas.destroy', $kumpultugas->id_pengumpulan) }}"
                                                        type="button"
