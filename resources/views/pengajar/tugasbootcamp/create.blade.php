    ...
    <div class="row">
        <div class="col">
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('pengajar.tugasbootcamp.store') }}" method="POST" enctype="multipart/form-data"
                        class="form-ajax">
                        @csrf
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('pengajar.tugasbootcamp.index', ['id_bootcamp' => request('id_bootcamp')]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
