                ...
                <div class="card-body">
                    <form action="{{ route('pengajar.materibootcamp.update', $materibootcamps->id_materi_bootcamp) }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px;">
                                            ...
                                            @if($materibootcamps->file)
                                                <p>File Saat Ini: <a href="{{ asset('files_materibootcamps/' . $materibootcamps->file) }}" target="_blank">{{ $materibootcamps->file }}</a></p>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('pengajar.materibootcamp.index', ['id_bootcamp' => $materibootcamps->id_bootcamp]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
