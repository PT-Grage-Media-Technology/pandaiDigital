    ...
    <div class="row">
        <div class="col">
            <div class="card card-shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('pengajar.tugas.store') }}" method="POST" enctype="multipart/form-data"
                        class="form-ajax">
                        @csrf
                                ...
                                <tr>
                                    <td style="padding: 5px;">
                                        @foreach ($materis as $materi)
                                            @if(request('id_materi') == $materi->id_materi)
                                                <input type="hidden" class="form-control" value="{{ $materi->nama_materi }}" style="background-color: #d3d3d3;" readonly>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <a href="{{ route('pengajar.tugas.index', ['id_materi' => request('id_materi')]) }}" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
