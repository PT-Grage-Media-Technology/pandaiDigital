...
class IsimateriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'url' => route('administrator.isimateri.index', ['id_materi' => $request->id_materi]), // Mengarahkan ke halaman isi_materi
            'success' => true,
    ...
    public function update(Request $request, string $id)
    {
        ...
        return response()->json([
            'url' => route('administrator.isimateri.index', ['id_materi' => $request->id_materi]),
            'success' => true,
