...
class AppController extends Controller
{
    ...
    public function companyprofile(Request $request){
        ...
        if ($templateDinas3 && $templateDinas3->aktif === 'Y') {
            ...
            return view('dinas-3.dashboard', compact('kategoriBerita','identitas','polings','logo', 'banners', 'pilihan', 'jawaban', 'links', 'menus', 'alamat', 'beritas', 'infos', 'agendas', 'beritau', 'beritao', 'beritad', 'videos'));
        } elseif ($templateDinas2 && $templateDinas2->aktif === 'Y') {
            // Jika 'dinas-2' aktif (aktif = 'Y'), tampilkan view dari folder 'dinas-2'
            return view('dinas-2.dashboard', compact('kategoriBerita','identitas','polings', 'logo', 'banners', 'pilihan', 'jawaban', 'links', 'menus', 'alamat', 'beritas', 'infos', 'agendas', 'beritau', 'beritao', 'beritad', 'videos'));
        } else {
            // Jika tidak ada template yang aktif, tampilkan view default
            return view('error.index', compact('identitas','polings','logo', 'banners', 'pilihan', 'jawaban', 'links', 'menus', 'alamat', 'beritas', 'infos', 'agendas', 'beritau', 'beritao', 'beritad', 'videos'));
        }
    }
}
