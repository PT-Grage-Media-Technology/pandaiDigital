    ...
    <div class="col">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('administrator.bannerslider.create') }}" class="btn btn-primary btn-sm">Tambah Data</a>
            </div>

            <!-- Tambahkan form pencarian -->
            <div class="card-body">
                <form action="{{ route('administrator.bannerslider.index') }}" method="GET" class="mb-1">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="input-group" style="max-width: 300px;">
                            <input type="text" class="form-control" placeholder="Cari Banner Slider..." name="search" value="{{ request('search') }}">
                            <div class="input-group-append">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-bordered" id="datatable-basic">
                        ...
                        <tbody>
                            @foreach ($bannersliders as $index => $banner)
                            <tr>
                                <td>{{ $loop->iteration + $bannersliders->firstItem() - 1 }}</td>
                                <td>{{ $banner->judul }}</td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <button data-url="{{ route('administrator.bannerslider.destroy', $banner->id_banner) }}"
                    ...
                    <br>
                    {{ $bannersliders->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(function() {
        ...
        function updateRowNumbers() {
            let startingIndex = {{ $bannersliders->firstItem() - 1 }};
