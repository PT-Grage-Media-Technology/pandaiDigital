    ...
    <div class="col">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="mb-0">Benefit</h3>
                <a href="{{ route('administrator.benefit.create') }}" class="btn btn-primary btn-sm">Tambah Data</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('administrator.benefit.edit', $benefit->id_benefit) }}" class="btn btn-success btn-sm d-inline-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px;">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <button data-url="{{ route('administrator.benefit.destroy', $benefit->id_benefit) }}"
