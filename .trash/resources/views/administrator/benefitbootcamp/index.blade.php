    ...
    <div class="col">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="mb-0">Benefit Bootcamp</h3>
                <a href="{{ route('administrator.benefitbootcamp.create') }}" class="btn btn-primary btn-sm">Tambah Data</a>
            </div>
                ...
                <div class="table-responsive py-4">
                    <table class="table table-bordered" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->iteration + $benefits->firstItem() - 1 }}</td>
                                <td>{{ $benefit->nama_benefit }}</td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('administrator.benefitbootcamp.edit', $benefit->id_benefitcamp) }}" class="btn btn-success btn-sm d-inline-flex align-items-center justify-content-center me-2" style="width: 32px; height: 32px;">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <button data-url="{{ route('administrator.benefitbootcamp.destroy', $benefit->id_benefitcamp) }}"
                    ...
                    <br>
                    {{ $benefits->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(function() {
        ...
        function updateRowNumbers() {
            let startingIndex = {{ $benefits->firstItem() - 1 }};
